...
#include "des.h"		// WE INCLUDE OUR CUSTOM MADE HEADER FILE HERE
...
// BELOW WE DEFINE PERMUTATION SETS FOR KEY AS WELL AS MESSAGE
...
printf("Invalid number of parameter specified.\n Usage:\n  %s -g \n %s -e <hexa_key> <plaintext_file> <output_file>\n %s -d <hexa_key> <encrypted_file> <decrypted_file> \n" , argv[0], argv[0], argv[0]);
...
void print_key_set(key_bunch key_set){
	int i;
	printf("K: \n");
	for (i=0; i<8; i++) {
